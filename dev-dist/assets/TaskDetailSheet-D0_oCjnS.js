import { a as Checkbox, o as MessageSquare, s as Circle } from "./tabs-CctlRPcX.js";
import { t as Clock } from "./clock-DkvGNUnG.js";
import { t as Ellipsis } from "./ellipsis-D-7FMn13.js";
import { i as Trash2 } from "./dist-BuxHy__k.js";
import { A as useProjectStore_default, C as SheetTitle, Ct as useCallbackRef, Lt as require_react, Ot as require_jsx_runtime, Pt as useNavigate, Rt as __commonJSMin, S as SheetDescription, St as useLayoutEffect2, a as SelectItem, b as Sheet, ct as Network, f as ptBR, gt as Calendar, ht as Check, i as SelectContent, m as format, nt as cn, o as SelectTrigger, pt as CircleAlert, r as Select, s as SelectValue, st as Plus, u as generateId, vt as createLucideIcon, x as SheetContent, z as Primitive, zt as __toESM } from "./index-C59AXJt2.js";
import { t as Badge } from "./badge-E-XZ20H7.js";
import { n as CardContent, t as Card } from "./card-BdPGic5X.js";
...
function TasksBoard({ tasks, updateTask, onCardClick }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [columnsConfig.map((col) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("w-[340px] shrink-0 flex flex-col rounded-2xl transition-all duration-200 relative", isDragOver && "bg-accent ring-2 ring-primary/20"),
				onDragOver: (e) => {
					e.preventDefault();
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "font-bold text-sm text-foreground tracking-wide",
								children: col.label
							}),
					...
					children: [colTasks.map((t) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
							...
							className: cn("cursor-grab active:cursor-grabbing border-border bg-card transition-all", isDragging ? "opacity-40 shadow-none" : "shadow-sm hover:shadow-md hover:border-primary/40"),
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
											variant: "outline",
											className: cn("px-2 py-0.5 text-[10px] font-bold border-border bg-background", t.categoryColor || "text-muted-foreground", isCompleted && "opacity-60"),
											children: t.category || "Geral"
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: cn("text-muted-foreground", isCompleted && "opacity-60"),
											children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										className: cn("font-bold text-sm leading-snug", isCompleted ? "line-through text-muted-foreground opacity-70" : "text-foreground"),
										children: t.title
									}),
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											...
											children: t.assignees?.map((assignee, idx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
												className: cn("w-6 h-6 rounded-full flex items-center justify-center text-[9px] font-bold text-white border-[1.5px] border-card", assignee.color, isCompleted && "opacity-70"),
												children: assignee.initials
											}, idx))
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
											className: "flex items-center gap-2",
											children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
												className: cn("text-[10px] font-bold uppercase tracking-wider", t.dateColor || "text-muted-foreground", isCompleted && "opacity-60", t.status === "Em Progresso" && t.progress !== void 0 && "text-foreground"),
						...
						className: "w-full mt-1 py-3 rounded-xl border border-dashed border-border text-muted-foreground text-xs font-bold hover:bg-accent hover:text-foreground flex items-center justify-center gap-1.5 transition-colors",
			...
			className: "w-[340px] shrink-0 flex flex-col rounded-2xl border border-dashed border-border h-[140px] items-center justify-center text-muted-foreground hover:bg-accent hover:text-foreground transition-colors cursor-pointer mt-10",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sheet, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(SheetContent, {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "bg-card px-6 py-5 flex flex-col border-b border-border z-10",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "flex justify-between items-center mb-4 pr-6",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 text-muted-foreground text-xs font-semibold",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									className: "w-8 h-8 flex items-center justify-center rounded-full text-muted-foreground hover:bg-accent hover:text-foreground transition-colors",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							...
							className: cn("w-7 h-7 rounded-full border flex items-center justify-center transition-colors shrink-0", localTask.status === "Concluída" ? "bg-success border-success text-success-foreground" : "border-border text-transparent hover:border-primary hover:text-primary/50"),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mb-10",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
								className: "text-[10px] font-bold uppercase tracking-widest text-muted-foreground mb-3 block",
								children: "Descrição"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "bg-background rounded-2xl p-5 border border-border focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/10 transition-all shadow-sm",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "absolute bottom-0 left-0 right-0 bg-muted border-t border-border p-4 flex items-end gap-3 z-20",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Avatar, {
						...
						className: "flex-1 bg-background rounded-2xl border border-border flex flex-col p-2 focus-within:border-primary/50 focus-within:ring-2 focus-within:ring-primary/10 transition-all shadow-sm",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("textarea", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
									className: "p-1.5 hover:text-primary hover:bg-accent rounded-md transition-colors",
								...
								className: "w-8 h-8 rounded-full bg-primary text-primary-foreground flex items-center justify-center hover:bg-primary/90 transition-all shadow-sm hover:scale-105 transform shrink-0",
...
//# sourceMappingURL=TaskDetailSheet-D0_oCjnS.js.map
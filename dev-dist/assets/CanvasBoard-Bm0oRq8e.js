import { t as ArrowRight } from "./arrow-right-Bnj0OonU.js";
import { a as Checkbox, i as TabsTrigger, n as TabsContent, o as MessageSquare, r as TabsList, s as Circle, t as Tabs } from "./tabs-CctlRPcX.js";
import { t as Clock } from "./clock-DkvGNUnG.js";
import { n as Image, t as Link } from "./link-DM9ME396.js";
import { i as Trash2 } from "./dist-BuxHy__k.js";
import { $ as TooltipTrigger, At as composeEventHandlers, D as useDocumentStore_default, Dt as createContextScope, F as DialogFooter, I as DialogHeader, It as useSearchParams, L as DialogTitle, Lt as require_react, M as Dialog, N as DialogContent, O as useTaskStore_default, Ot as require_jsx_runtime, Pt as useNavigate, Q as TooltipContent, T as Button, Z as Tooltip, a as SelectItem, at as SquareCheckBig, bt as useControllableState, c as usePrevious, et as useSize, ft as FileText, i as SelectContent, j as createStore, jt as useToast, k as useFunnelStore_default, kt as useComposedRefs, lt as LayoutTemplate, m as format, n as Textarea, nt as cn, o as SelectTrigger, r as Select, rt as X, s as SelectValue, st as Plus, t as Label, u as generateId, vt as createLucideIcon, w as Input, wt as Primitive, zt as __toESM } from "./index-C59AXJt2.js";
import { t as Badge } from "./badge-E-XZ20H7.js";
import { t as ConfirmDialog } from "./ConfirmDialog-C-h31MzG.js";
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			!hideHeader && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				className: "absolute top-0 left-0 right-0 h-20 bg-card border-b border-border px-6 flex items-center justify-between z-40 shadow-sm",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					selectedEdgeObj && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								className: cn("flex-1 h-9 rounded-[8px] border-[1.5px] flex items-center justify-center transition-colors", selectedEdgeObj.style?.strokeDasharray === "none" || !selectedEdgeObj.style?.strokeDasharray ? "border-primary bg-primary/10 text-primary" : "border-border bg-background hover:bg-muted text-muted-foreground"),
								...
								className: cn("flex-1 h-9 rounded-[8px] border-[1.5px] flex items-center justify-center transition-colors", selectedEdgeObj.style?.strokeDasharray === "8 8" ? "border-primary bg-primary/10 text-primary" : "border-border bg-background hover:bg-muted text-muted-foreground"),
...
//# sourceMappingURL=CanvasBoard-Bm0oRq8e.js.map
...
import { Bt as __export, C as Input, D as useTaskStore_default, E as useDocumentStore_default, Nt as Link, O as useFunnelStore_default, Rt as require_react, S as constructFrom, Vt as __toESM, _ as format, at as Plus, b as normalizeDates, et as cn, ft as FileText, g as isBefore, h as ptBR, k as useProjectStore_default, kt as require_jsx_runtime, lt as Layers, m as useQuickActionStore_default, mt as CircleAlert, nt as SquareCheckBig, ot as Network, v as isSameDay, w as Button, x as startOfWeek, xt as clsx_default, y as startOfDay, yt as createLucideIcon, zt as __commonJSMin } from "./index-BgGqzoz0.js";
import { t as Badge } from "./badge-C0b4p0I1.js";
import { t as EmptyState } from "./empty-state-CiiGyVRm.js";
import { i as CardTitle, n as CardContent, r as CardHeader, t as Card } from "./card-CK3tVprV.js";
...
function isThisWeek(date$1, options) {
	return isSameWeek(constructFrom(options?.in || date$1, date$1), constructNow(options?.in || date$1), options);
}
function isToday(date$1, options) {
	return isSameDay(constructFrom(options?.in || date$1, date$1), constructNow(options?.in || date$1));
}
...
var require__baseIsNative = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var isFunction$19 = require_isFunction(), isMasked = require__isMasked(), isObject$9 = require_isObject(), toSource$1 = require__toSource();
	var reRegExpChar = /[\\^$.*+?()[\]{}|]/g;
	...
	function baseIsNative$1(value) {
		...
		return (isFunction$19(value) ? reIsNative : reIsHostCtor).test(toSource$1(value));
	}
...
var adaptEventsOfChild = function adaptEventsOfChild$1(props, data, index) {
	if (!(0, import_isObject$3.default)(props) || _typeof$45(props) !== "object") return null;
	var out = null;
...
var isValidSpreadableProp = function isValidSpreadableProp$1(property$2, key, includeEvents, svgElementType) {
	...
	return key.startsWith("data-") || !(0, import_isFunction$17.default)(property$2) && (svgElementType && matchingElementTypeKeys.includes(key) || SVGElementPropKeys.includes(key)) || includeEvents && EventKeys.includes(key);
};
...
function _getPrototypeOf$16(o) {
	_getPrototypeOf$16 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
...
function _setPrototypeOf$16(o, p) {
	_setPrototypeOf$16 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
		...
		},
		{
			...
			value: function renderItems() {
				...
				return payload.map(function(entry, i) {
					...
					var className = clsx_default(_defineProperty$39(_defineProperty$39({ "recharts-legend-item": true }, "legend-item-".concat(i), true), "inactive", entry.inactive));
					if (entry.type === "none") return null;
					var entryValue = !(0, import_isFunction$16.default)(entry.value) ? entry.value : null;
					warn(!(0, import_isFunction$16.default)(entry.value), "The name property is also required when using a function for the dataKey of a chart's cartesian components. Ex: <Bar name=\"Name of my Data\"/>");
...
var require_isArrayLike = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var isFunction$16 = require_isFunction(), isLength$1 = require_isLength();
	function isArrayLike$5(value) {
		return value != null && isLength$1(value.length) && !isFunction$16(value);
	}
...
function getUniqPayload(payload, option, defaultUniqBy$2) {
	...
	if ((0, import_isFunction$15.default)(option)) return (0, import_uniqBy.default)(payload, option);
	return payload;
}
...
function _getPrototypeOf$15(o) {
	_getPrototypeOf$15 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$15(o, p) {
	_setPrototypeOf$15 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function getTooltipCSSClassName(_ref) {
	...
	return clsx_default(CSS_CLASS_PREFIX, _defineProperty$36(_defineProperty$36(_defineProperty$36(_defineProperty$36({}, "".concat(CSS_CLASS_PREFIX, "-right"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX >= coordinate.x), "".concat(CSS_CLASS_PREFIX, "-left"), isNumber(translateX) && coordinate && isNumber(coordinate.x) && translateX < coordinate.x), "".concat(CSS_CLASS_PREFIX, "-bottom"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY >= coordinate.y), "".concat(CSS_CLASS_PREFIX, "-top"), isNumber(translateY) && coordinate && isNumber(coordinate.y) && translateY < coordinate.y));
}
...
function _getPrototypeOf$14(o) {
	_getPrototypeOf$14 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$14(o, p) {
	_setPrototypeOf$14 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function _getPrototypeOf$13(o) {
	_getPrototypeOf$13 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$13(o, p) {
	_setPrototypeOf$13 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
var require_decimal = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(globalScope) {
		...
		function checkInt32(i, min$3, max$4) {
			if (i !== ~~i || i < min$3 || i > max$4) throw Error(invalidArgument + i);
		}
...
function _getPrototypeOf$12(o) {
	_getPrototypeOf$12 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$12(o, p) {
	_setPrototypeOf$12 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function getValueByDataKey(obj, dataKey, defaultValue) {
	...
	if ((0, import_isFunction$14.default)(dataKey)) return dataKey(obj);
	return defaultValue;
}
...
var parseScale = function parseScale$1(axis, chartType, hasBar) {
	...
	return (0, import_isFunction$14.default)(scale) ? { scale } : {
		scale: point(),
		realScaleType: "point"
	};
};
...
var parseSpecifiedDomain = function parseSpecifiedDomain$1(specifiedDomain, dataDomain, allowDataOverflow) {
	if ((0, import_isFunction$14.default)(specifiedDomain)) return specifiedDomain(dataDomain, allowDataOverflow);
	...
	} else if ((0, import_isFunction$14.default)(specifiedDomain[0])) domain[0] = specifiedDomain[0](dataDomain[0]);
	...
	} else if ((0, import_isFunction$14.default)(specifiedDomain[1])) domain[1] = specifiedDomain[1](dataDomain[1]);
...
var getLabel = function getLabel$1(props) {
	...
	if ((0, import_isFunction$12.default)(formatter)) return formatter(label);
	return label;
};
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel$1(props) {
	...
	if ((0, import_isObject$1.default)(position) && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$24({
...
function Label(_ref4) {
	...
	if (!viewBox || (0, import_isNil$5.default)(value) && (0, import_isNil$5.default)(children) && !/* @__PURE__ */ (0, import_react.isValidElement)(content) && !(0, import_isFunction$12.default)(content)) return null;
	if (/* @__PURE__ */ (0, import_react.isValidElement)(content)) return /* @__PURE__ */ (0, import_react.cloneElement)(content, props);
	var label;
	if ((0, import_isFunction$12.default)(content)) {
	...
	return /* @__PURE__ */ import_react.createElement(Text, _extends$19({ className: clsx_default("recharts-label", className) }, attrs, positionAttrs, { breakAll: textBreakAll }), label);
}
...
var parseLabel = function parseLabel$1(label, viewBox) {
	...
	if ((0, import_isFunction$12.default)(label)) return /* @__PURE__ */ import_react.createElement(Label, {
		key: "label-implicit",
		content: label,
		viewBox
	});
	if ((0, import_isObject$1.default)(label)) return /* @__PURE__ */ import_react.createElement(Label, _extends$19({ viewBox }, label, { key: "label-implicit" }));
	return null;
};
...
function LabelList(_ref) {
	...
	return /* @__PURE__ */ import_react.createElement(Layer, { className: "recharts-label-list" }, data.map(function(entry, index) {
		...
		return /* @__PURE__ */ import_react.createElement(Label, _extends$18({}, filterProps(entry, true), others, idProps, {
			...
			value,
			textBreakAll,
			viewBox: Label.parseViewBox((0, import_isNil$4.default)(clockWise) ? entry : _objectSpread$23(_objectSpread$23({}, entry), {}, { clockWise })),
			key: "label-".concat(index),
			index
		}));
	}));
...
function parseLabelList(label, data) {
	...
	if (/* @__PURE__ */ import_react.isValidElement(label) || (0, import_isFunction$11.default)(label)) return /* @__PURE__ */ import_react.createElement(LabelList, {
		key: "labelList-implicit",
		data,
		content: label
	});
...
var getCurveFactory = function getCurveFactory$1(type, layout) {
	if ((0, import_isFunction$10.default)(type)) return type;
...
function combineComparators(comparatorA, comparatorB) {
	return function isEqual$6(a$1, b, state) {
...
function createIsEqual({ circular, comparator, createState, equals, strict }) {
	if (createState) return function isEqual$6(a$1, b) {
	...
	if (circular) return function isEqual$6(a$1, b) {
		return comparator(a$1, b, {
	...
	return function isEqual$6(a$1, b) {
...
function _setPrototypeOf$11(o, p) {
	_setPrototypeOf$11 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function _getPrototypeOf$11(o) {
	_getPrototypeOf$11 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
var Rectangle = function Rectangle$1(rectangleProps) {
	var props = _objectSpread$17(_objectSpread$17({}, defaultProps$1), rectangleProps);
...
var Cross = function Cross$1(_ref) {
	var _ref$x = _ref.x, x$1 = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y$1 = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$7(_ref, _excluded$7);
...
function Shape(_ref2) {
	...
	else if ((0, import_isFunction$9.default)(option)) shape = option(props);
...
function _getPrototypeOf$10(o) {
	_getPrototypeOf$10 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$10(o, p) {
	_setPrototypeOf$10 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
	...
	return _createClass$12(Brush$1, [
		...
		},
		{
			...
			value: function getTextOfTick(index) {
				...
				return (0, import_isFunction$8.default)(tickFormatter) ? tickFormatter(text, index) : text;
			}
		},
		{
		...
		},
		{
			...
			value: function renderTraveller(option, props) {
				...
				else if ((0, import_isFunction$8.default)(option)) rectangle = option(props);
...
function typeguardBarRectangleProps(_ref, props) {
	...
	return _objectSpread$11(_objectSpread$11(_objectSpread$11(_objectSpread$11(_objectSpread$11({}, props), option), x$1 ? { x: x$1 } : {}), y$1 ? { y: y$1 } : {}), {}, {
		height,
		width,
		name: props.name,
		radius: props.radius
...
function _getPrototypeOf$9(o) {
	_getPrototypeOf$9 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$9(o, p) {
	_setPrototypeOf$9 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
var formatAxisMap = function formatAxisMap$1(props, axisMap, offset, axisType, chartName) {
	...
	return ids.reduce(function(result, id) {
		...
		var ticks$1 = getTicksOfScale(scale, _objectSpread$9(_objectSpread$9({}, axis), {}, { realScaleType }));
		if (axisType === "xAxis") {
		...
		var finalAxis = _objectSpread$9(_objectSpread$9(_objectSpread$9({}, axis), ticks$1), {}, {
			realScaleType,
			x: x$1,
			y: y$1,
			scale,
...
function _getPrototypeOf$8(o) {
	_getPrototypeOf$8 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$8(o, p) {
	_setPrototypeOf$8 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
var renderLine = function renderLine$1(option, props) {
	...
	else if ((0, import_isFunction$7.default)(option)) line = option(props);
...
function _getPrototypeOf$7(o) {
	_getPrototypeOf$7 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$7(o, p) {
	_setPrototypeOf$7 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
_defineProperty$10(ReferenceDot, "renderDot", function(option, props) {
	...
	else if ((0, import_isFunction$6.default)(option)) dot = option(props);
...
function _getPrototypeOf$6(o) {
	_getPrototypeOf$6 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$6(o, p) {
	_setPrototypeOf$6 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
var ReferenceArea = /* @__PURE__ */ function(_React$Component) {
	...
	return _createClass$7(ReferenceArea$1, [{
		...
		value: function render() {
			...
			return /* @__PURE__ */ import_react.createElement(Layer, { className: clsx_default("recharts-reference-area", className) }, ReferenceArea$1.renderRect(shape, _objectSpread$6(_objectSpread$6({ clipPath }, filterProps(this.props, true)), rect)), Label.renderCallByParent(this.props, rect));
		}
	}]);
}(import_react.Component);
...
_defineProperty$9(ReferenceArea, "renderRect", function(option, props) {
	...
	else if ((0, import_isFunction$5.default)(option)) rect = option(props);
...
function getTicksEnd(sign$1, boundaries, getTickSize, ticks$1, minTickGap) {
	...
	var _loop = function _loop$1(i$1) {
		...
		if (i$1 === len - 1) {
			...
			result[i$1] = entry = _objectSpread$5(_objectSpread$5({}, entry), {}, { tickCoord: gap > 0 ? entry.coordinate - gap * sign$1 : entry.coordinate });
		} else result[i$1] = entry = _objectSpread$5(_objectSpread$5({}, entry), {}, { tickCoord: entry.coordinate });
		if (isVisible(sign$1, entry.tickCoord, getSize, start, end)) {
			end = entry.tickCoord - sign$1 * (getSize() / 2 + minTickGap);
			result[i$1] = _objectSpread$5(_objectSpread$5({}, entry), {}, { isShow: true });
		}
	};
...
function getTicksStart(sign$1, boundaries, getTickSize, ticks$1, minTickGap, preserveEnd) {
	...
	if (preserveEnd) {
		...
		result[len - 1] = tail = _objectSpread$5(_objectSpread$5({}, tail), {}, { tickCoord: tailGap > 0 ? tail.coordinate - tailGap * sign$1 : tail.coordinate });
...
function getTicks(props, fontSize, letterSpacing) {
	...
	var getTickSize = function getTickSize$1(content, index) {
		var value = (0, import_isFunction$4.default)(tickFormatter) ? tickFormatter(content.value, index) : content.value;
...
function _getPrototypeOf$5(o) {
	_getPrototypeOf$5 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$5(o, p) {
	_setPrototypeOf$5 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
	...
	return _createClass$6(CartesianAxis$1, [
		...
		},
		{
			...
			value: function renderAxisLine() {
				...
				return /* @__PURE__ */ import_react.createElement("line", _extends$5({}, props, { className: clsx_default("recharts-cartesian-axis-line", (0, import_get$1.default)(axisLine, "className")) }));
			}
		},
		{
			key: "renderTicks",
			value: function renderTicks(ticks$1, fontSize, letterSpacing) {
				...
				var finalTicks = getTicks(_objectSpread$4(_objectSpread$4({}, this.props), {}, { ticks: ticks$1 }), fontSize, letterSpacing);
				...
				var items = finalTicks.map(function(entry, i) {
					...
					}, adaptEventsOfChild(_this2.props, entry, i)), tickLine && /* @__PURE__ */ import_react.createElement("line", _extends$5({}, tickLineProps, lineCoord, { className: clsx_default("recharts-cartesian-axis-tick-line", (0, import_get$1.default)(tickLine, "className")) })), tick && CartesianAxis$1.renderTickItem(tick, tickProps, "".concat((0, import_isFunction$3.default)(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit$1 || "")));
				});
		...
		},
		{
			...
			value: function render() {
				...
				var _this$props8 = this.props, ticks$1 = _this$props8.ticks, noTicksProps = _objectWithoutProperties$3(_this$props8, _excluded3);
				var finalTicks = ticks$1;
				if ((0, import_isFunction$3.default)(ticksGenerator)) finalTicks = ticks$1 && ticks$1.length > 0 ? ticksGenerator(this.props) : ticksGenerator(noTicksProps);
		...
		value: function renderTickItem(option, props, value) {
			...
			else if ((0, import_isFunction$3.default)(option)) tickItem = option(_objectSpread$4(_objectSpread$4({}, props), {}, { className: combinedClassName }));
...
function _getPrototypeOf$4(o) {
	_getPrototypeOf$4 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$4(o, p) {
	_setPrototypeOf$4 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function _getPrototypeOf$3(o) {
	_getPrototypeOf$3 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$3(o, p) {
	_setPrototypeOf$3 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
			...
			value: function renderAreaWithAnimation(needClip, clipPathId) {
				...
				return /* @__PURE__ */ import_react.createElement(es6_default, {
					...
					if (prevPoints) {
						...
						else if ((0, import_isNil$1.default)(baseLine) || (0, import_isNaN.default)(baseLine)) stepBaseLine = interpolateNumber(prevBaseLine, 0)(t);
...
function _getPrototypeOf$2(o) {
	_getPrototypeOf$2 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$2(o, p) {
	_setPrototypeOf$2 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function _getPrototypeOf$1(o) {
	_getPrototypeOf$1 = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf$1(o, p) {
	_setPrototypeOf$1 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function _getPrototypeOf(o) {
	_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf$17(o$1) {
		return o$1.__proto__ || Object.getPrototypeOf(o$1);
	};
...
function _setPrototypeOf(o, p) {
	_setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf$17(o$1, p$1) {
		o$1.__proto__ = p$1;
		return o$1;
	};
...
function Index() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					...
					className: "text-muted-foreground capitalize text-base font-medium",
		...
		}), isWorkspaceEmpty ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
			icon: Layers,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
				className: "bg-card border border-border shadow-sm p-8 flex flex-col lg:flex-row items-center gap-8 relative overflow-hidden group",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "space-y-4 flex-1 relative z-10",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-bold",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Activity, { size: 16 }), " Visão Geral Semanal"]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
							className: "text-4xl font-bold tracking-tight text-foreground leading-tight",
							children: [completedTasks, " Tarefas Concluídas"]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-muted-foreground text-base max-w-md font-medium",
							children: [
								"Você e sua equipe gerenciaram",
								" ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", {
									className: "text-foreground",
									children: [activeProjects, " projetos"]
								}),
								" ",
								"ativos e concluíram",
								" ",
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("strong", {
									className: "text-foreground",
									children: [completedTasks, " tarefas"]
								}),
								" ",
								"esta semana. O ritmo de entregas subiu",
								" ",
					...
					className: "w-full lg:w-[50%] h-[220px] relative z-10",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						className: "hover-lift p-6 flex flex-col justify-between min-h-[140px] relative overflow-hidden bg-card border-border",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Layers, { className: "h-5 w-5 text-primary" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									...
									className: "text-success text-xs font-bold mt-2 flex items-center gap-1",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "absolute bottom-0 right-0 w-2/3 h-1/2 opacity-10 pointer-events-none",
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChartContainer, {
									config: { value: { color: "hsl(var(--primary))" } },
									className: "h-full w-full",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LineChart, {
										data: sparklineDataDocs,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Network, { className: "h-5 w-5 text-info" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative z-10",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-4xl font-bold text-foreground",
								...
								className: "text-muted-foreground text-xs font-bold mt-2",
								children: [
									"Em ",
									projects.length,
									" projetos"
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SquareCheckBig, { className: "h-5 w-5 text-success" })]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "relative z-10",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
								className: "text-xs font-bold text-muted-foreground uppercase tracking-wider",
								children: "Documentos"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FileText, { className: "h-5 w-5 text-warning" })]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "relative z-10",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-4xl font-bold text-foreground",
								...
								className: "text-muted-foreground text-xs font-bold mt-2",
								children: "Atualizados recentemente"
							})]
						})]
					})
				]
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
										className: "text-sm font-bold text-danger flex items-center gap-1.5",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleAlert, { size: 16 }), " Atrasadas"]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										variant: "outline",
										className: "bg-danger/10 text-danger border-danger/20 font-bold",
									...
									children: [overdueTasks.slice(0, 4).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-sm font-bold text-foreground truncate flex-1 mr-2",
											children: t.title
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "text-xs text-danger font-bold shrink-0",
											children: safeFormatDate(t.deadline, "dd/MM")
										})]
									}, t.id)), overdueTasks.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-sm text-muted-foreground py-2 font-medium",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
									className: "flex flex-row items-center justify-between pb-2",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
										className: "text-sm font-bold text-warning flex items-center gap-1.5",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarDays, { size: 16 }), " Hoje"]
									}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
										variant: "outline",
										className: "bg-warning/10 text-warning border-warning/20 font-bold",
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
								className: "flex flex-row items-center justify-between pb-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardTitle, {
									className: "text-sm font-bold text-info flex items-center gap-1.5",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CalendarClock, { size: 16 }), " Esta Semana"]
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
									variant: "outline",
									className: "bg-info/10 text-info border-info/20 font-bold",
								...
								children: [weekTasks.slice(0, 4).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
										...
										className: "text-xs text-muted-foreground font-bold shrink-0",
										children: safeFormatDate(t.deadline, "dd/MM")
									})]
					...
					children: projects.slice(0, 3).map((p) => {
						...
						return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
								className: "hover-lift cursor-pointer h-full group p-6 border border-border shadow-sm",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										className: "flex justify-between items-start mb-4",
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
											className: "font-bold text-lg group-hover:text-primary transition-colors text-foreground",
											children: p.name
										}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Badge, {
											variant: "outline",
											className: p.status === "Ativo" ? "bg-success/10 text-success border-none font-bold" : "bg-muted text-muted-foreground border-none font-bold",
											children: p.status
										})]
									}),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "text-sm text-muted-foreground line-clamp-2 mb-6 font-medium leading-relaxed",
...
//# sourceMappingURL=Index-C0bTU7J8.js.map
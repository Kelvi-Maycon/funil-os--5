import { t as ArrowRight } from "./arrow-right-CO7RZEMO.js";
import { a as Checkbox, i as TabsTrigger, n as TabsContent, o as MessageSquare, r as TabsList, s as Circle, t as Tabs } from "./tabs-CO9jZsMA.js";
import { t as Clock } from "./clock-CfZ_DCxm.js";
import { n as Image, t as Link } from "./link-CDVqVxuF.js";
import { i as Trash2 } from "./dist-BzObIVqX.js";
import { A as useDocumentStore_default, B as DialogTitle, D as Input, F as Dialog, Ft as composeEventHandlers, Gt as __toESM, Ht as require_react, I as DialogContent, It as useToast, M as useFunnelStore_default, Mt as createContextScope, Nt as require_jsx_runtime, O as Button, P as createStore, Pt as useComposedRefs, R as DialogFooter, St as createLucideIcon, Tt as useControllableState, Vt as useSearchParams, a as Textarea, at as cn, c as SelectItem, ct as SquareCheckBig, d as usePrevious, dt as Plus, et as Tooltip, gt as FileText, i as Label, j as useTaskStore_default, kt as Primitive, l as SelectTrigger, lt as Settings, n as PopoverContent, nt as TooltipTrigger, o as Select, ot as X, p as generateId, pt as LayoutTemplate, r as PopoverTrigger, rt as useSize, s as SelectContent, t as Popover, tt as TooltipContent, u as SelectValue, z as DialogHeader, zt as useNavigate } from "./index-BBV0FkD8.js";
import { t as Badge } from "./badge-C2lK6XB7.js";
import { t as ConfirmDialog } from "./ConfirmDialog-6Ch-j5lQ.js";
...
function BlockPalette({ funnel }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "w-[260px] max-h-[calc(100vh-140px)] bg-card rounded-2xl border border-border shadow-[0_4px_24px_rgba(0,0,0,0.12)] flex flex-col overflow-hidden",
...
function NodeItem({ node, selected, isNodeDragging, snapToGrid, activeTool, taskProgress, onPointerDownAction, onMove, onMoveEnd, onResize, onResizeEnd, scale, onOpenRightPanel, onOpenSettings, onToggleComplete, onDelete, onAddChild, onTextChange, onEdgeDragStart, onDropResource }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("absolute -top-3.5 right-4 flex items-center gap-1.5 z-20 transition-all duration-200", selected || isHovered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2 pointer-events-none"),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "text-[12px] uppercase tracking-[0.08em] font-bold text-muted-foreground",
					children: node.type
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					className: cn("font-bold text-[16px] truncate leading-tight transition-all text-foreground", node.data.isCompleted && "line-through opacity-70"),
					children: node.data.name
				}), node.data.subtitle && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-[14px] mt-1 truncate font-medium text-muted-foreground",
			...
			node.data.isTaskMode && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [linkedTasks.map((task) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox, {
						...
						className: cn("text-[14px] leading-tight font-bold flex-1 transition-all break-words", task.status === "Concluído" ? "text-muted-foreground line-through" : "text-foreground"),
						children: task.title
					})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: cn("absolute -bottom-4 left-1/2 -translate-x-1/2 z-20 flex items-center interactive-icon transition-all duration-200", selected || isHovered ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-2 pointer-events-none"),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
						className: "mx-6 mt-6 grid grid-cols-4 gap-1 bg-background p-1 rounded-lg border border-border",
						children: [
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
									className: "flex-1 bg-background border-border rounded-lg text-foreground font-bold h-11",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: linkedResources.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [a.type === "image" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
									...
									className: "p-3 text-[14px] font-bold text-foreground border-t border-border",
									children: a.title
								})]
							}, a.id))
						})]
...
function NodeSettingsModal({ node, isOpen, onClose, onSave }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogContent, {
			className: "sm:max-w-[500px] max-h-[85vh] overflow-y-auto p-6 flex flex-col gap-6 bg-card border-border shadow-2xl sm:rounded-2xl",
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tabs, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsList, {
							className: "flex w-full bg-background rounded-xl p-1.5 mb-6 h-auto gap-1",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsTrigger, {
									value: "conf",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
							...
							children: [
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									className: "flex flex-row items-center justify-between rounded-xl border border-border bg-background p-4",
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
											className: "h-[40px] rounded-lg bg-background border-border font-medium",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TabsContent, {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [nodeTasks.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
												...
												className: cn("h-9 rounded-lg bg-card font-bold text-[14px] border-border text-foreground shadow-sm focus-visible:border-primary", t.status === "Concluído" && "line-through text-muted-foreground opacity-70")
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
												variant: "ghost",
												size: "icon",
										...
										children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Select, {
											...
											children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SelectTrigger, {
												className: "h-8 rounded-lg text-[12px] w-[110px] bg-card border-border text-foreground font-bold shadow-sm",
									...
									className: "text-[14px] text-muted-foreground text-center py-8 font-bold bg-background rounded-xl border border-dashed border-border",
...
var EdgeItem = (0, import_react.memo)(({ edge, sourceNode, targetNode, isSelected, activeTool, edgeStyle, onSelect }) => {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("path", {
		...
		onClick: onSelect
	}), edge.label && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("foreignObject", {
		x: midX - 60,
		y: midY - 12,
		width: "120",
		height: "24",
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "bg-background border border-border text-xs px-2 py-0.5 rounded-md font-bold text-foreground whitespace-nowrap shadow-sm truncate max-w-[120px]",
				children: edge.label
			})
		})
	})] });
...
var EdgeItemWrapper = (0, import_react.memo)(({ edge, sourceNode, targetNode, isSelected, store, activeTool, edgeStyle, onSelect }) => {
...
var selectedNodesIncludes = (store, id) => false;
...
function CanvasBoard({ funnel, onChange, hideHeader, onBack }) {
	...
	(0, import_react.useEffect)(() => {
		const handleKeyDown = (e) => {
			...
			switch (e.key.toLowerCase()) {
				...
				case "delete":
				case "backspace":
					if (latest.current.selectedNodes.length > 0 || selectedEdge) setNodeToDelete("selected");
					break;
				case "z":
					if (e.ctrlKey || e.metaKey) {
						e.preventDefault();
						e.shiftKey ? redo(latest.current.funnel, onChange) : undo(latest.current.funnel, onChange);
					}
					break;
			}
		};
	...
	const handleDeleteSelected = (0, import_react.useCallback)(() => {
		...
		if (selectedNodes$1.length > 0) {
			...
			onChangeWithHistory({
				...funnel$1,
				edges: funnel$1.edges.filter((e) => e.id !== selectedEdge)
			});
	...
	const updateEdgeStyle = (updates) => {
		if (selectedEdge) onChangeWithHistory({
			...
			edges: funnel.edges.map((e) => e.id === selectedEdge ? {
				...
				label: updates.label !== void 0 ? updates.label : e.label
			} : e)
		});
	};
	...
	const handleNodePointerDown = (0, import_react.useCallback)((id, shiftKey) => {
		...
		if (!selectedNodes$1.includes(id)) if (shiftKey) setSelectedNodes([...new Set([...selectedNodes$1, ...groupMembers])]);
		else {
	...
	const isToolbarActive = activeTool !== "Select" || selectedNodes.length > 0 || selectedEdge || creatingShape;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			!hideHeader && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "bg-success/10 text-success px-2.5 py-1 rounded-[8px] text-xs font-bold border border-success/20",
							children: "Publicado"
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex bg-background p-1 rounded-lg border border-border",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: "px-4 py-1.5 rounded-md bg-card text-primary text-sm font-bold shadow-sm",
						children: "Editar"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						className: "px-4 py-1.5 rounded-md text-muted-foreground text-sm font-bold hover:text-foreground transition-colors",
						children: "Analytics"
					})]
				})]
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("absolute bottom-8 left-1/2 -translate-x-1/2 flex items-center p-2 bg-card rounded-2xl shadow-lg border border-border z-40 gap-1.5 transition-all duration-300", isToolbarActive ? "opacity-100 translate-y-0" : "opacity-40 hover:opacity-100 translate-y-2 hover:translate-y-0"),
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: "ghost",
							size: "icon",
							className: cn("w-10 h-10 rounded-xl", activeTool === "Select" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-primary"),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: "ghost",
							size: "icon",
							className: cn("w-10 h-10 rounded-xl", activeTool === "Pan" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-primary"),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Popover, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopoverTrigger, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: "ghost",
							size: "icon",
							className: cn("w-10 h-10 rounded-xl", [
								"Rectangle",
								"Circle",
								"Diamond",
								"Line",
								"Arrow"
							].includes(activeTool) ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-primary"),
						...
						children: [
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, { children: "Retângulo" })] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
								asChild: true,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									variant: "ghost",
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, { children: "Elipse" })] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
								asChild: true,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									variant: "ghost",
									...
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Hexagon, { size: 16 })
								})
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, { children: "Losango" })] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
								asChild: true,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									variant: "ghost",
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, { children: "Seta" })] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
								asChild: true,
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									variant: "ghost",
							...
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, { children: "Linha" })] })
						]
					})] })
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "absolute right-6 bottom-6 flex items-center p-1.5 bg-card rounded-xl shadow-lg border border-border z-30 gap-1.5",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						variant: "ghost",
						size: "icon",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						variant: "ghost",
						size: "icon",
						className: cn("w-10 h-10 rounded-lg transition-colors", showMinimap ? "bg-primary/10 text-primary" : "text-muted-foreground hover:text-primary"),
			...
			showMinimap && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "absolute right-6 bottom-[88px] transition-all duration-300 w-56 h-36 bg-card border border-border shadow-lg rounded-xl overflow-hidden z-30 cursor-crosshair",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [funnel.nodes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: cn("absolute rounded-xl opacity-60", [
							"Square",
							"Rectangle",
							"Diamond",
							"Circle",
			...
			showPropertiesPanel && !rightPanelState && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "absolute top-24 right-6 bg-card rounded-2xl shadow-xl border border-border p-5 w-[280px] flex flex-col gap-6 z-40 max-h-[80vh] overflow-y-auto",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						className: "section-label",
						children: isMultiSelect ? "MÚLTIPLOS" : selectedNodeObj ? "ESTILO" : selectedEdgeObj ? "LINHA" : "CANVAS"
					}),
					...
					(selectedNodeObj || isMultiSelect) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "space-y-3",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							className: "section-label block",
							...
							children: [
								...
								className: cn("w-7 h-7 rounded-md border-2 transition-transform", selectedNodeObj?.style?.fill === c || selectedNodeObj?.data?.color === c || c === "transparent" && !selectedNodeObj?.style?.fill && !selectedNodeObj?.data?.color ? "border-foreground scale-110" : "border-transparent shadow-sm hover:scale-110"),
								style: {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
							...
							children: [
								...
								className: cn("w-7 h-7 rounded-md border-2 transition-transform shadow-sm", selectedNodeObj?.style?.stroke === c || selectedNodeObj?.style?.color === c ? "border-foreground scale-110" : "border-transparent hover:scale-110"),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("svg", {
						...
						className: "absolute inset-0 w-full h-full pointer-events-none",
						children: funnel.nodes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(NodeItemWrapper, {
							node: n,
							...
							onMove: (dx, dy) => ephemeralStore.setState({ dragState: {
								isDragging: true,
								dx,
								dy
							} }),
							...
							onDelete: () => {
								selectedNodes.includes(n.id) ? setNodeToDelete("selected") : setNodeToDelete(n.id);
							},
...
//# sourceMappingURL=CanvasBoard-DwpuOdd2.js.map
import { a as ArrowLeft, i as TabsTrigger, n as TabsContent, r as TabsList, t as Tabs } from "./tabs-BxYIhXDr.js";
import { t as ArrowRight } from "./arrow-right-sTqW5dBW.js";
import { A as createStore, At as useComposedRefs, B as Content, C as Input, Ct as Presence, D as useTaskStore_default, Dt as createSlottable, E as useDocumentStore_default, F as DialogHeader, Ft as useNavigate, G as Title, H as Overlay, I as DialogTitle, It as useParams, J as createDialogScope, K as Trigger, Lt as useSearchParams, M as DialogContent, Mt as useToast, O as useFunnelStore_default, Ot as createContextScope, P as DialogFooter, Q as useSize, Rt as require_react, St as useControllableState, T as buttonVariants, Tt as Primitive, U as Portal, V as Description, Vt as __toESM, W as Root$1, X as TooltipContent, Y as Tooltip, Z as TooltipTrigger, a as Textarea, at as Plus, c as SelectItem, ct as LayoutTemplate, d as usePrevious, et as cn, ft as FileText, gt as Check, i as Label, j as Dialog, jt as composeEventHandlers, kt as require_jsx_runtime, l as SelectTrigger, n as PopoverContent, nt as SquareCheckBig, o as Select, p as generateId, pt as CreditCard, q as WarningProvider, r as PopoverTrigger, rt as Settings, s as SelectContent, t as Popover, tt as X, u as SelectValue, ut as Image, w as Button, yt as createLucideIcon, z as Close } from "./index-WvayVERT.js";
import { t as useResourceStore_default } from "./useResourceStore-C__NcitS.js";
import { t as Badge } from "./badge-CvQ8-8qF.js";
...
function NodeItem({ node, selected, isNodeDragging, snapToGrid, activeTool, taskProgress, onPointerDownAction, onMove, onMoveEnd, onResize, onResizeEnd, scale, onOpenRightPanel, onOpenSettings, onToggleComplete, onDelete, onAddChild, onTextChange, onEdgeDragStart, onDropResource }) {
	...
	if (node.type === "Text") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("absolute top-0 left-0 pointer-events-auto min-w-[150px] max-w-[400px] p-4 rounded-xl shadow-sm text-foreground z-10 group", selected && "ring-2 ring-primary/60 shadow-md", !currentlyDragging && "transition-transform duration-150", currentlyDragging ? "opacity-95 z-50 cursor-grabbing shadow-xl ring-2 ring-primary/50" : isPanMode ? "cursor-grab" : isSelectMode ? isEditingText ? "cursor-text" : "cursor-pointer" : ""),
		style: {
			transform: `translate3d(${node.x}px, ${node.y}px, 0) scale(${currentlyDragging ? 1.02 : 1})`,
			transformOrigin: "center center",
	...
	if (node.type === "Image") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("absolute top-0 left-0 pointer-events-auto w-[300px] rounded-xl shadow-sm border border-border bg-white z-10 overflow-hidden group", selected && "ring-4 ring-primary/40 border-primary shadow-md", !currentlyDragging && "transition-transform duration-150", currentlyDragging ? "opacity-95 z-50 cursor-grabbing shadow-xl ring-4 ring-primary/50" : isPanMode ? "cursor-grab" : isSelectMode ? "cursor-pointer" : ""),
		style: {
			transform: `translate3d(${node.x}px, ${node.y}px, 0) scale(${currentlyDragging ? 1.02 : 1})`,
			transformOrigin: "center center",
			willChange: "transform"
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("absolute top-0 left-0 pointer-events-auto w-[240px] rounded-xl px-6 py-4 z-10 flex flex-col group select-none duration-200 hover-lift", !currentlyDragging ? "transition-[box-shadow,background-color,border-color,opacity,transform]" : "transition-[box-shadow,background-color,border-color,opacity]", !customFill && !customStroke && "bg-card border border-border shadow-sm", isHovered && !selected && !customFill && "shadow-md", selected && "border-primary shadow-md ring-2 ring-primary/20", currentlyDragging && "opacity-95 z-50 shadow-2xl", node.data.isCompleted && "opacity-70 grayscale-[30%]"),
		style: {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					hasDocs && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
						asChild: true,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "flex items-center justify-center w-8 h-8 rounded-full bg-white border border-border shadow-sm text-primary cursor-help transition-transform hover:scale-110",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: cn("absolute -top-4 right-2 flex items-center gap-2 z-30 transition-all duration-200 bg-card border border-border p-1 rounded-lg shadow-sm", selected || isHovered ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2 pointer-events-none"),
				children: [
					...
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipContent, { children: "Configurações" })] }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-px h-4 bg-border" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Tooltip, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TooltipTrigger, {
						asChild: true,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: (e) => {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					className: "text-xs uppercase tracking-[0.08em] font-bold text-muted-foreground",
					children: node.type
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
					className: cn("font-bold text-base truncate leading-tight transition-all text-foreground", node.data.isCompleted && "line-through opacity-70"),
					children: node.data.name
				}), node.data.subtitle && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: "text-sm mt-2 truncate font-medium text-muted-foreground",
			...
			node.data.isTaskMode && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [linkedTasks.map((task) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Checkbox, {
						...
						className: cn("text-sm leading-tight font-bold flex-1 transition-all break-words", task.status === "Concluído" ? "text-muted-foreground line-through" : "text-foreground"),
						children: task.title
					})]
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogContent, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(AlertDialogHeader, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(AlertDialogTitle, {
				...
				onClick: onConfirm,
				className: cn("rounded-full", variant === "destructive" ? buttonVariants({
					variant: "destructive",
					className: "rounded-full"
				}) : ""),
...
var EdgeItem = (0, import_react.memo)(({ edge, sourceNode, targetNode, isSelected, activeTool, edgeStyle, onSelect }) => {
	...
	const strokeColor = edge.style?.stroke || (isSelected ? "hsl(var(--primary))" : "hsl(var(--muted-foreground))");
...
function CanvasBoard({ funnel, onChange, hideHeader, onBack }) {
	...
	const showPropertiesPanel = isMultiSelect || selectedNodeObj || selectedEdgeObj;
			...
			showPropertiesPanel && !rightPanelState && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h4", {
						className: "section-label",
						children: isMultiSelect ? "MÚLTIPLOS" : selectedNodeObj ? "ESTILO" : "LINHA"
					}),
...
//# sourceMappingURL=Canvas-DG5vaRz4.js.map
  ...
  return (
    <div className="p-8 max-w-[1600px] w-full mx-auto space-y-8 animate-fade-in">
      ...
      {isWorkspaceEmpty ? (
        ...
        <>
          <Card className="bg-card border border-border shadow-sm p-8 flex flex-col lg:flex-row items-center gap-8 relative overflow-hidden group">
            <div className="space-y-4 flex-1 relative z-10">
              ...
              <p className="text-muted-foreground text-base max-w-md font-medium">
                ...
                <span className="text-success font-bold">12%</span> em relação à
                semana passada.
              </p>
              <div className="pt-2">
                <Button
            ...
            <div className="w-full lg:w-[50%] h-[220px] relative z-10">
              <ChartContainer
                config={{
                  tasks: { color: 'hsl(var(--primary))', label: 'Tarefas' },
                  projects: { color: 'hsl(var(--info))', label: 'Projetos' },
                }}
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="hover-lift p-6 flex flex-col justify-between min-h-[140px] relative overflow-hidden bg-card border-border">
              ...
              <div className="relative z-10">
                ...
                <div className="text-success text-xs font-bold mt-2 flex items-center gap-1">
                  <TrendingUp size={14} strokeWidth={3} /> Crescimento constante
                </div>
              </div>
            ...
            <Card className="hover-lift p-6 flex flex-col justify-between min-h-[140px] relative overflow-hidden bg-card border-border">
              ...
              <div className="relative z-10">
                ...
                <div className="text-success text-xs font-bold mt-2 flex items-center gap-1">
                  <TrendingUp size={14} strokeWidth={3} /> Meta atingida
                </div>
              </div>
              <div className="absolute bottom-0 right-0 w-2/3 h-1/2 opacity-10 pointer-events-none">
                <ChartContainer
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle className="text-sm font-bold text-info flex items-center gap-1.5">
                    <CalendarClock size={16} /> Esta Semana
                  </CardTitle>
                  <Badge
                    variant="outline"
                    ...
                    <Card className="hover-lift cursor-pointer h-full group p-6 border border-border shadow-sm">
                      ...
                      <div className="flex items-center gap-4 text-xs font-bold text-muted-foreground">
                        <span className="flex items-center gap-1.5">
                          ...
                          {stats.pFunnels} funis
                        </span>
                        <span className="flex items-center gap-1.5">
                          <CheckSquare size={14} className="text-primary/70" />{' '}
                          {stats.pTasks} tasks
                        </span>
                        <span className="flex items-center gap-1.5">

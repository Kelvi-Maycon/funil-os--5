...
export function NodeSettingsModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-[500px] max-h-[85vh] overflow-y-auto p-6 flex flex-col gap-6 bg-card border-border shadow-2xl sm:rounded-[24px]">
        <DialogHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <DialogTitle className="text-[28px] font-bold tracking-tight text-foreground">
            {name || 'Node'}
          </DialogTitle>
        </DialogHeader>

        <Tabs defaultValue="conf" className="w-full flex-1">
          <TabsList className="flex w-full bg-background rounded-full p-1.5 mb-6 h-auto gap-1">
            <TabsTrigger
              value="conf"
          ...
          <TabsContent value="conf" className="space-y-6 outline-none">
            ...
            <div className="flex flex-row items-center justify-between rounded-[12px] border border-border bg-background p-4">
          ...
          <TabsContent value="docs" className="space-y-4 outline-none">
            <div className="space-y-3">
              ...
              >
                <SelectTrigger className="h-[40px] rounded-[8px] bg-background border-border font-medium">
                  <SelectValue placeholder="Buscar documento..." />
                </SelectTrigger>
                <SelectContent className="rounded-[8px] border-border shadow-lg">
                  {docs
          ...
          <TabsContent value="tasks" className="space-y-4 outline-none">
            <div className="space-y-3 max-h-[300px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-border">
                ...
                >
                  <div className="flex gap-3 items-center">
                    ...
                    <Input
                      ...
                      className={cn(
                        'h-9 rounded-[8px] bg-card font-bold text-[13px] border-border text-foreground shadow-sm focus-visible:border-primary',
                        t.status === 'Concluído' &&
                  ...
                  <div className="flex gap-2 pl-8">
                    ...
                    >
                      <SelectTrigger className="h-8 rounded-[8px] text-[12px] w-[110px] bg-card border-border text-foreground font-bold shadow-sm">
              ...
              {nodeTasks.length === 0 && (
                <div className="text-[13px] text-muted-foreground text-center py-8 font-bold bg-background rounded-[12px] border border-dashed border-border">
        ...
        <DialogFooter className="mt-4 sm:justify-end gap-3 pt-4 border-t border-border">
          <Button onClick={handleSave} className="w-full rounded-[8px] h-12">
            Salvar Alterações
          </Button>
        </DialogFooter>
      </DialogContent>
